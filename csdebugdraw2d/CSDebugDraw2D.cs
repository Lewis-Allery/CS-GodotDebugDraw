...
public partial class CSDebugDraw2D : Node2D
{
private static readonly Color _defaultRed = Colors.Red;
    ...
    public static void Rect(Vector2 center, Vector2 size = default, Color? color = null, int lineWidth = 1, float duration = 0)
    {
        DebugRect2D rect = new(center, size, color ?? Colors.Red, false, lineWidth, duration);
        _rects.Add(rect);
    }

    public static void RectFilled(Vector2 center, Vector2 size = default, Color? color = null, int lineWidth = 1, float duration = 0)
    {
